...
export class PriceFeed__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceFeed__proposedGetRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceFeed__proposedLatestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PriceFeed extends ethereum.SmartContract {
  ...
  latestRoundData(): PriceFeed__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new PriceFeed__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<PriceFeed__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceFeed__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedGetRoundData(
    _roundId: BigInt
  ): PriceFeed__proposedGetRoundDataResult {
    let result = super.call(
      "proposedGetRoundData",
    ...
    return new PriceFeed__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<PriceFeed__proposedGetRoundDataResult> {
    let result = super.tryCall(
      "proposedGetRoundData",
      "proposedGetRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceFeed__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(): PriceFeed__proposedLatestRoundDataResult {
    let result = super.call(
    ...
    return new PriceFeed__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(): ethereum.CallResult<
    PriceFeed__proposedLatestRoundDataResult
  > {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PriceFeed__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
